...
app.controller('IdentityCtl', ['$scope', '$stateParams', 'IdentityService',
  ...
  function ($scope, $stateParams, IdentityService, ngDialog,
    ...
    $scope.addNewFlowRule = function (resource, type) {
      ...
      var dialogTitle;
      if (type === 0) {
          dialogTitle = "新增流控规则-内存";
      } else if (type === 1) {
          dialogTitle = "新增流控规则-Nacos";
      }
      ...
      //     showAdvanceButton : true
      // };
      flowRuleDialogScope.saveRule = function () {saveFlowRule(type)};
